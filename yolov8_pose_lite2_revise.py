...
target = "RK3588"
rknn_model_path = "/data00/aWinDir/D/dotnet/py_project/rknn-toolkit2-2.3.2/rknn-toolkit-lite2/yolov8_pose_rknn/models/yolov8_pose.rknn"
...
if __name__ == '__main__':
    ...
    #基本参数配置
    img_path = "/data00/aWinDir/D/dotnet/py_project/rknn-toolkit2-2.3.2/rknn-toolkit-lite2/yolov8_pose_rknn/input/bus.jpg"
    rknn_lite = RKNNLite()
    ...
    infer_img = np.expand_dims(infer_img, axis=0)  #添加batch维度(HWC -> NHWC)
